            ...
            <div className="formulario">
              ...
              <div className="form-group">
                <input
                  ...
                  onChange={(e) => setNuevoCliente({...nuevoCliente, nombre: (e.target as HTMLInputElement).value})}
                />
                <input
                  type="text"
                  placeholder="Teléfono"
                  value={nuevoCliente.telefono}
                  onChange={(e) => setNuevoCliente({...nuevoCliente, telefono: (e.target as HTMLInputElement).value})}
                />
                <input
                  type="email"
                  placeholder="Correo"
                  value={nuevoCliente.correo}
                  onChange={(e) => setNuevoCliente({...nuevoCliente, correo: (e.target as HTMLInputElement).value})}
                />
              ...
              <div className="formulario">
                ...
                <div className="form-group">
                  <input
                    ...
                    onChange={(e) => setNuevoPago({...nuevoPago, cliente: (e.target as HTMLInputElement).value})}
                  />
                  <input
                    type="text"
                    placeholder="Monto"
                    value={nuevoPago.monto}
                    onChange={(e) => setNuevoPago({...nuevoPago, monto: (e.target as HTMLInputElement).value})}
                  />
                  <input
                    type="text"
                    placeholder="Fecha (dd/mm/aaaa)"
                    value={nuevoPago.fecha}
                    onChange={(e) => setNuevoPago({...nuevoPago, fecha: (e.target as HTMLInputElement).value})}
                  />
